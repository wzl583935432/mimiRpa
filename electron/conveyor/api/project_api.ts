...
export class ProjectApi extends ConveyorApi {
      ...
      ExportProject = (projectId:string, projectVersion:string) => this.invoke('project_export', projectId, projectVersion)
      ...
      DeleteNode= (projectId:string, projectVersion:string, nodeId:string)=> this.invoke('delete_node', projectId, projectVersion, nodeId)
}
